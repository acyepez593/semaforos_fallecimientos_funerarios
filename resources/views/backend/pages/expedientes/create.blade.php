            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.expedientes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="tipo_ingreso_id">Seleccione Tipo de Ingreso:</label>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <div class="datepicker date input-group">
                                    <input type="text" placeholder="Fecha Ingreso Expediente" class="form-control @error('fecha_ingreso_expediente') is-invalid @enderror" id="fecha_ingreso_expediente" name="fecha_ingreso_expediente" value="{{ old('fecha_ingreso_expediente') }}">
                                    <div class="input-group-append">
                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
