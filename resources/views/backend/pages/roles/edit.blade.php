            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <h4 class="header-title">Editar Rol - {{ $role->name }}</h4>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" value="{{ $role->name }}" name="name" onkeyup="this.value = this.value.toUpperCase();" placeholder="Nombre Rol" required autofocus>
                        </div>
