        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>{{ __('Todos los Roles') }}</span></li>
                </ul>
            </div>
        </div>
                                    ...
                                    <td>
                                        ...
                                        @if (auth::user()->can('admin.edit'))
                                            <a class="btn btn-danger text-white" href="javascript:void(0);"
                                                onclick="event.preventDefault(); if(confirm('Esta seguro de que quiere borrar este registro?')) { document.getElementById('delete-form-{{ $role->id }}').submit(); }">
                                                {{ __('Borrar') }}
                                            </a>
